...
const Roadmap = () => {
  ...
  const careerProgress = savedProgress[selectedCareer] || [];

  const handleToggleStep = (index) => {
    const updatedProgress = { ...savedProgress };

    const currentCareerProgress = updatedProgress[selectedCareer] || [];

    if (currentCareerProgress.includes(index)) {
      updatedProgress[selectedCareer] = currentCareerProgress.filter(
        (item) => item !== index
      );
    } else {
      updatedProgress[selectedCareer] = [...currentCareerProgress, index];
    }
